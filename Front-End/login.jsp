		...
		<nav class="navbar navbar-fixed-top navbar-default role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand hidden-lg"> RS INFORMATICA - INICIO DE SESION</a>
					<a href="#" class="navbar-brand visible-lg"> INICIO DE SESION</a>
				</div>
	...
	<section class="main container">
		...
		<form action="Login" method="post" class="">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="form-group ">
						<label class="" for="password">Contraseña:</label> <input
							class="form-control" name="password" id="password"
							type="password" placeholder="Cotraseña" required>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="form-group">
						<a href="" data-toggle="modal" data-target="#forgotpassword">Recuperar Contraseña </a>
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body ">
						...
						<form action="ForgotPassword" method="post" class=" form-inline" id="recuperarcontraseñaform" role="form" >
							...
							<div class="modal-footer">
								<input type="submit" id="recuperarcontraseña" value="enviar" class="btn btn-danger col-md-2 col-md-offset-5 col-xs-4 col-xs-offset-4 ">
